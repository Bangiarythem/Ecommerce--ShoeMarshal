      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-mute-foreground">Based on 100 charges</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="font-bold">Total Sales</CardTitle>
            <ShoppingBag className="h-4 w-4 text-blue-500" />
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">+50</p>
            <p className="text-xs text-mute-foreground">
              Totals Sales on ShoeMarshal
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="font-bold">Total Users</CardTitle>
            ...
            <CardContent className="flex flex-col gap-8">
                <div className="flex items-center gap-4">
                    ...
                    <div className="grid gap-1">
                        <p className="text-sm font-medium">Rythem Bangia</p>
